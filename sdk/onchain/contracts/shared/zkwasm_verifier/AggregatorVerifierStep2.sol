...
buf[31] = AggregatorLib.fr_div(addmod(buf[31], mulmod(mulmod(buf[34], addmod(transcript[97], AggregatorLib.q_mod - transcript[98], AggregatorLib.q_mod), AggregatorLib.q_mod), buf[38], AggregatorLib.q_mod), AggregatorLib.q_mod), buf[36], aux[16]);
...
buf[31] = AggregatorLib.fr_div(1, addmod(buf[6], AggregatorLib.q_mod - buf[24], AggregatorLib.q_mod), aux[17]);
